...
(function () {
    ...
    function Runner(outerContainerId, opt_config) {
        ...
        if (this.isDisabled()) {
            ...
            darkModeMediaQuery.addListener(this.loadImagesOnChange.bind(this));
        }
    }
    ...
    Runner.prototype = {
        ...
        loadImages: function () {
            if (this.isDarkMode()) {
                if (IS_HIDPI) {
                    Runner.imageSprite = document.getElementById('offline-resources-dark-2x');
                    this.spriteDef = Runner.spriteDefinition.HDPI;
                } else {
                    Runner.imageSprite = document.getElementById('offline-resources-dark-1x');
                    this.spriteDef = Runner.spriteDefinition.LDPI;
                }
            } else {
                if (IS_HIDPI) {
                    Runner.imageSprite = document.getElementById('offline-resources-light-2x');
                    this.spriteDef = Runner.spriteDefinition.HDPI;
                } else {
                    Runner.imageSprite = document.getElementById('offline-resources-light-1x');
                    this.spriteDef = Runner.spriteDefinition.LDPI;
            }
            }
        ...
        init: function () {
            ...
            // Add listener for changes in color scheme
            var darkModeMediaQuery = window.matchMedia('(prefers-color-scheme: dark)');
            darkModeMediaQuery.addListener(this.setBackgroundColor.bind(this));
